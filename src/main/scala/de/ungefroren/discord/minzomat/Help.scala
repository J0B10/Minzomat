...
object Help {
  ...
  val Embed: AminzingEmbed = AminzingEmbed(
    """$embed:
      ...
      |$suthor-url: https://github.com/joblo2213/Minzomat/wiki
      ...
      |
      |1️⃣  **Write your own embeds** [🇬🇧](https://github.com/joblo2213/Minzomat/wiki/write_embeds_en) / [🇩🇪](https://github.com/joblo2213/Minzomat/wiki/write_embeds_de)
      |   _Allows you to send a embed just like a normal message_
      |
      |2️⃣  **Quote messages  _[🔧 WIP]_**
      |   _Allows you to show what another user wrote some time ago inside an embed_
      |   _This Feature is not finished yet._
      |
      |3️⃣  **Large reactions  _[🔧 WIP]_**
